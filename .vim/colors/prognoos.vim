hi clear
syntax reset
let g:colors_name = "prognoos"
if &background == "light"
    hi Boolean gui=NONE guifg=#707070 guibg=NONE
    hi ColorColumn gui=NONE guifg=NONE guibg=lightred
    hi Comment gui=NONE guifg=#c2c0c3 guibg=NONE
    ...
    hi DiffAdd gui=NONE guifg=NONE guibg=#eeffee
    hi DiffChange gui=NONE guifg=NONE guibg=#f5f5f5
    hi DiffDelete gui=NONE guifg=NONE guibg=#ffeeee
    hi DiffText gui=NONE guifg=NONE guibg=#e3e3e3
    hi Directory gui=NONE guifg=#4a4a4a guibg=NONE
    hi Error gui=NONE guifg=NONE guibg=#ffeeee
    hi ErrorMsg gui=NONE guifg=NONE guibg=#ffeeee
    ...
    hi Normal gui=NONE guifg=#858386 guibg=#ffffff
    hi Number gui=NONE guifg=#3572ab guibg=NONE
    ...
    hi SpellBad gui=undercurl guisp=NONE guifg=NONE guibg=#ffeeee
    hi SpellCap gui=undercurl guisp=NONE guifg=NONE guibg=NONE
    hi SpellLocal gui=undercurl guisp=NONE guifg=NONE guibg=#eeffee
    hi SpellRare gui=undercurl guisp=NONE guifg=NONE guibg=#ededed
    hi Statement gui=NONE guifg=#389899 guibg=NONE
    hi StatusLine gui=NONE guifg=#262626 guibg=#ededed
    hi StatusLineNC gui=NONE guifg=#969696 guibg=#ededed
    hi StorageClass gui=NONE guifg=#6d6581 guibg=NONE
    hi String gui=NONE guifg=#8199de guibg=NONE

hi clear
syntax reset
let g:colors_name = "cognitivo-light"
if &background == "light"
    hi Boolean gui=NONE guifg=#ff3333 guibg=NONE
    hi ColorColumn gui=NONE guifg=NONE guibg=#f5f5f5
    hi Comment gui=NONE guifg=#bebbbb guibg=NONE
    hi Conceal gui=NONE guifg=#707070 guibg=NONE
    hi Conditional gui=bold guifg=#ff4242 guibg=NONE
    hi Constant gui=NONE guifg=#707070 guibg=NONE
    hi Cursor gui=reverse guifg=NONE guibg=NONE
    hi CursorColumn gui=NONE guifg=NONE guibg=#f5f5f5
    hi CursorLine gui=NONE guifg=NONE guibg=#919191
    hi CursorLineNr gui=NONE guifg=#969696 guibg=NONE
    hi DiffAdd gui=NONE guifg=NONE guibg=#3cdd84
    hi DiffChange gui=NONE guifg=NONE guibg=#636363
    hi DiffDelete gui=NONE guifg=NONE guibg=#ff2929
    hi DiffText gui=NONE guifg=NONE guibg=#28c870
    hi Directory gui=NONE guifg=#ff4d4d guibg=NONE
    hi Error gui=NONE guifg=NONE guibg=#fff0f0
    hi ErrorMsg gui=NONE guifg=NONE guibg=#ff0037
    hi FoldColumn gui=NONE guifg=#c2c2c2 guibg=NONE
    hi Folded gui=NONE guifg=#ffbc85 guibg=NONE
    hi Ignore gui=NONE guifg=NONE guibg=NONE
    hi IncSearch gui=NONE guifg=NONE guibg=#ff5500
    ...
    hi Normal gui=NONE guifg=#ffffff guibg=#5254ff
    hi Number gui=NONE guifg=#fff5f5 guibg=NONE
    hi Pmenu gui=NONE guifg=NONE guibg=#ff8e24
    ...
    hi Search gui=NONE guifg=NONE guibg=#ffaf75
    hi SignColumn gui=NONE guifg=#c2c2c2 guibg=NONE
    hi Special gui=bold guifg=#ff6e00 guibg=NONE
    hi SpecialKey gui=NONE guifg=#c2c2c2 guibg=NONE
    hi SpellBad gui=undercurl guisp=NONE guifg=NONE guibg=#ff4747
    hi SpellCap gui=undercurl guisp=NONE guifg=NONE guibg=NONE
    hi SpellLocal gui=undercurl guisp=NONE guifg=NONE guibg=#23c731
    hi SpellRare gui=undercurl guisp=NONE guifg=NONE guibg=#079d52
    hi Statement gui=NONE guifg=#ffc266 guibg=NONE
    hi StatusLine gui=NONE guifg=#262626 guibg=#ededed
    hi StatusLineNC gui=NONE guifg=#969696 guibg=#ededed
    hi StorageClass gui=bold guifg=#ff5757 guibg=NONE
    hi String gui=NONE guifg=#b0b0b0 guibg=NONE
    ...
    hi Title gui=bold guifg=#f8923f guibg=NONE
    hi Todo gui=standout guifg=NONE guibg=NONE
    hi Type gui=bold guifg=#fa758b guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
    hi VertSplit gui=NONE guifg=#e3e3e3 guibg=NONE
    hi Visual gui=NONE guifg=#ffffff guibg=#ffb67a
    hi VisualNOS gui=NONE guifg=NONE guibg=NONE
    hi WarningMsg gui=NONE guifg=NONE guibg=#ff6a00
